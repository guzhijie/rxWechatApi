...
public interface AccountManagement {
   ...
   * https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=TICKET 提醒：TICKET记得进行UrlEncode<br>
   *
   * @param ticket
   * @return
   */
  ...
  /**
   * 将一条长链接转成短链接 http请求方式: POST https://api.weixin.qq.com/cgi-bin/shorturl?access_token=ACCESS_TOKEN
   *
   * @param access_token
   * @param body
   * @return
  ...
  @POST("shorturl")
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> shorturl(
      @Query("access_token") String access_token, @Body Map<String, String> body);
}
