...
public interface TagManagement {
  ...
  Single<JSONObject> create_tag(
      @Query("access_token") String access_token, @Body Map<String, Object> tagInfo);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> get_tag_users(
      @Query("access_token") String access_token, @Body Map<String, Object> tagInfo);
}
