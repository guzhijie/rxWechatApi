...
public interface MessageManagement {
  ...
  Single<JSONObject> send_message(
      @Query("access_token") String access_token, @Body Message message);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> delete_message(
      @Query("access_token") String access_token, @Body Map<String, Long> messageParma);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> preview_message(
      @Query("access_token") String access_token, @Body Map<String, Long> messageParma);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> add_template(
      @Query("access_token") String access_token, @Body Map<String, String> template_id_short);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> send_template_message(
      @Query("access_token") String access_token, @Body TemplateMessage templateMessage);
}
