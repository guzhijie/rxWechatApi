...
public interface ImageTextStatistics {
  ...
  Single<JSONObject> getarticlesummary(
      @Query("access_token") String access_token, @Body DateInfo dateInfo);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> getarticletotal(
      @Query("access_token") String access_token, @Body DateInfo dateInfo);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> getuserreadhour(
      @Query("access_token") String access_token, @Body DateInfo dateInfo);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> getusershare(
      @Query("access_token") String access_token, @Body DateInfo dateInfo);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> getusersharehour(
      @Query("access_token") String access_token, @Body DateInfo dateInfo);
}
