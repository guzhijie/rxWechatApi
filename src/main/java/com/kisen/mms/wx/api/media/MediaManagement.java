...
public interface MediaManagement {
    ...
    Single<JSONObject> upload_media(@Query("access_token") String access_token,
    ...
    @GET("media/get")
    @JsonAndXmlConverterFactory.Json
    Single<ResponseBody> get_media(@Query("access_token") String access_token, @Query("media_id") String media_id);
}
