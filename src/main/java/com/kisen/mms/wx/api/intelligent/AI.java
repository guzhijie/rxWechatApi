...
public interface AI {
    ...
    Single<JSONObject> addvoicetorecofortext(@Query("access_token") String access_token,
    ...
    @JsonAndXmlConverterFactory.Json
    Single<JSONObject> queryrecoresultfortext(@Query("access_token") String access_token,
                                              @Query("voice_id") String voice_id,
                                              @Query("lang") String lang);
    ...
    @JsonAndXmlConverterFactory.Json
    Single<JSONObject> translatecontent(@Query("access_token") String access_token,
