...
public interface KFAccountManagement {
  ...
  Single<JSONObject> add_kfaccount(
      @Query("access_token") String access_token, @Body KFAccount kfAccount);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> update_kfaccount(
      @Query("access_token") String access_token, @Body KFAccount kfAccount);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> del_kfaccount(
      @Query("access_token") String access_token, @Body KFAccount kfAccount);
  ...
  @JsonAndXmlConverterFactory.Json
  Single<JSONObject> uploadheadimg(
      @Query("access_token") String access_token,
      @Query("kf_account") String kf_account,
